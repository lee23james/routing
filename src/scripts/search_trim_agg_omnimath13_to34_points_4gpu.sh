#!/usr/bin/env bash
# Search OmniMath 1<=diff<3 trained TRIM-Agg PPO checkpoints on the local 4-GPU box.
...
LOG_DIR="logs/trim_agg_omnimath13_to34_point_search"
...
run_one() {
  ...
  local tag="trim_agg_omnimath13_to34_point_search_lam${lam_tag}_seed${SEED}"
...
echo "[$(date '+%F %T')] all OmniMath 1-3 TRIM-Agg point-search training jobs finished"
